...
function normalizeDept(dept) {
  ...
  if (d === 'pipe' || d === 'ท่อ' || d === 'pipe' || d === 'ท่อ') return 'pipe';
...
const PROBLEM_TYPES = {
  pipe: ["ขี้ดายหลุด", "เข้าม้วนหัก", "โครไม่สวย", "เดินเครื่องใหม่", "ทะลุ", "น้ำท่วมถังแว็ก", "เปลี่ยนไซร้", "ไฟดับ", "แว็กตก", "แว็กสูง", "หนาบางกลางม้วน", "อื่นๆ"],
